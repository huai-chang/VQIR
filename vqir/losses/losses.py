...
class MultiQuantMatchLoss(nn.Module):
    ...
    def __init__(self, loss_opt):
        ...
        for level_name, level_opt in loss_opt.items():
            self.loss_dict[level_name] = build_loss(level_opt)
...
class EdgeLoss(nn.Module):
    def __init__(self, loss_weight=0.05, reduction='mean'):
        ...
        self.loss = L1Loss(loss_weight, reduction)
    ...
    def forward(self, pred, target, weight=None, **kwargs):
        ...
        Args:
            ...
            weight (Tensor, optional): of shape (N, C, H, W). Element-wise
                weights. Default: None.
        """
        return self.loss_weight * self.gram_loss(pred, target)
